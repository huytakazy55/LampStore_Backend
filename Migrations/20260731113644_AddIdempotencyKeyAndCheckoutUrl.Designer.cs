...
namespace LampStoreProjects.Migrations
{
    ...
    [Migration("20260731113644_AddIdempotencyKeyAndCheckoutUrl")]
    partial class AddIdempotencyKeyAndCheckoutUrl
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LampStoreProjects.Data.Banner", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.CartItem", b =>
                {
                    ...
                    b.HasIndex("CartId", "ProductId", "SelectedOptions")
                        .IsUnique()
                        .HasFilter("[CartId] IS NOT NULL AND [ProductId] IS NOT NULL AND [SelectedOptions] IS NOT NULL");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.DiscountCode", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.News", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.SiteVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.WishlistItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("LampStoreProjects.Data.Chat", b =>
                {
                    b.HasOne("ApplicationUser", "AssignedAdmin")
                        .WithMany()
            ...
            modelBuilder.Entity("LampStoreProjects.Data.ProductVariant", b =>
                {
                    b.HasOne("LampStoreProjects.Data.Product", "Product")
                        ...
                        .HasForeignKey("LampStoreProjects.Data.ProductVariant", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade);
